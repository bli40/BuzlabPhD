...
data_folder = Path(r'\\research-cifs.nyumc.org\research\buzsakilab\Buzsakilabspace\LabShare\ZutshiI\patchTask\N17\N17_250509_sess15')
...
##        #reward_ticks = ax1.plot(reward_cue_times, np.full(np.size(reward_cue_times), 1.625), label='Reward Cue', color='w', marker="|", mec='k')
        ...
        if mat_path.exists():
            print(f"Warning: overwriting {mat_path}")
